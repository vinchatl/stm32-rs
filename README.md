...
```
+----------------------------+    +----------------------------+    +----------------------------+
|  ST-supplied SVD archives  |    |   SVD peripheral patches   |    |  Peripheral fields detail  |
|      in 'svd/vendor/'      |    |    in 'devices/patches/'   |    |     in 'devices/fields'    |
+----------------------------+    +----------------------------+    +----------------------------+
              |                                  |                                 |
        `make extract`                           +----------------+----------------+
              |                                                   |
              v                                                   v
+----------------------------+                     +----------------------------+
|   ST-supplied SVD files    |                     |     SVD device patches     |
|         in 'svd/'          |                     |        in 'devices/'       |
+----------------------------+                     +----------------------------+
              |                                                   |
              +-----------------------+---------------------------+
